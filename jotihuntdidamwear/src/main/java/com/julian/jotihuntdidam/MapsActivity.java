package com.julian.jotihuntdidam;
...
public class MapsActivity extends Activity implements OnMapReadyCallback,
    ...
    public void onMapReady(GoogleMap googleMap) {
        if (mMap != null) {
            ...
            try {
                KmlLayer kmlLayerarea = new KmlLayer(googleMap, R.raw.jotihunt2015_deelgebieden, getApplicationContext());
                KmlLayer kmlLayerpoint = new KmlLayer(googleMap, R.raw.jotihunt2015_edit, getApplicationContext());
